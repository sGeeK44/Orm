...
namespace SmartWay.Orm.Filters
{
    ...
    public abstract class Condition : ICondition
    {
        ...
        protected IFilter LeftPart { get; }

        protected IFilter RightPart { get; }

        protected string ConditionValue { get; }
        ...
        /// <param name="condition">Condition to associate</param>
        /// <returns>New build condition</returns>
        public ICondition AndNot(ICondition condition)
        {
            return new And(_filterFactory, this, new Not(condition));
        }
